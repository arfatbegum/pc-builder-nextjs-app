        ...
        <section class="text-gray-700 body-font mb-8">
            <div class="container px-10 py-7 mx-auto">
                ...
                <div className="grid lg:grid-cols-6 md:grid-cols-3 grid-cols-1 gap-5 items-center mt-8">
                    <Link href="categories/processor" className="group group-hover:bg-opacity-60 transition duration-500 relative bg-white border-2 border-gray-100 flex justify-center items-center shadow-sm flex-col py-8">
                    ...
                    <Link href="categories/motherboard" className="group group-hover:bg-opacity-60 transition duration-500 relative bg-white border-2 border-gray-100 flex justify-center items-center shadow-sm flex-col py-8">
                    ...
                    <Link href="categories/power-suply-unit" className="group group-hover:bg-opacity-60 transition duration-500 relative bg-white border-2 border-gray-100 flex justify-center items-center shadow-sm flex-col py-8">
                    ...
                    <Link href="categories/storage-device" className="group group-hover:bg-opacity-60 transition duration-500 relative bg-white border-2 border-gray-100 flex justify-center items-center shadow-sm flex-col py-8">
                    ...
                    <Link href="categories/monitor" className="group group-hover:bg-opacity-60 transition duration-500 relative bg-white border-2 border-gray-100 flex justify-center items-center shadow-sm flex-col py-8">
                    ...
                    <Link href="categories/ram" className="group group-hover:bg-opacity-60 transition duration-500 relative bg-white border-2 border-gray-100 flex justify-center items-center shadow-sm flex-col py-8">
